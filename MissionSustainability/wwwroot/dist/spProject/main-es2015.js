...
/* harmony import */ var _badge_detail_badge_detail_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./badge-detail/badge-detail.component */ "./src/app/badge-detail/badge-detail.component.ts");
/* harmony import */ var _badges_badges_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./badges/badges.component */ "./src/app/badges/badges.component.ts");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BadgeDetailComponent", function() { return BadgeDetailComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm2015/common.js");
/* harmony import */ var _badge_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../badge.service */ "./src/app/badge.service.ts");
...
let BadgeDetailComponent = class BadgeDetailComponent {
    constructor(route, badgeService, location) {
        this.route = route;
...
BadgeDetailComponent.ctorParameters = () => [
...
BadgeDetailComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-badge-detail',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./badge-detail.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/badge-detail/badge-detail.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./badge-detail.component.css */ "./src/app/badge-detail/badge-detail.component.css")).default]
    })
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BadgeSearchComponent", function() { return BadgeSearchComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
let BadgeSearchComponent = class BadgeSearchComponent {
    ...
    ngOnInit() {
        this.badges$ = this.searchTerms.pipe(
        ...
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])((term) => this.badgeService.searchBadges(term)));
    }
};
BadgeSearchComponent.ctorParameters = () => [
    { type: _badge_service__WEBPACK_IMPORTED_MODULE_4__["BadgeService"] }
];
BadgeSearchComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-badge-search',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./badge-search.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/badge-search/badge-search.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./badge-search.component.css */ "./src/app/badge-search/badge-search.component.css")).default]
    })
...
let BadgeService = class BadgeService {
    ...
    getBadges() {
        return this.http.get(this.badgesUrl)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(_ => this.log('fetched badges')), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('getBadges', [])));
    }
    /** GET badge by id. Return `undefined` when id not found */
    getBadgeNo404(id) {
        const url = `${this.badgesUrl}/?id=${id}`;
        return this.http.get(url)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(badges => badges[0]), // returns a {0|1} element array
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(h => {
            const outcome = h ? `fetched` : `did not find`;
            this.log(`${outcome} badge id=${id}`);
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError(`getBadge id=${id}`)));
    }
    /** GET badge by id. Will 404 if id not found */
    getBadge(id) {
        const url = `${this.badgesUrl}/${id}`;
        return this.http.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(_ => this.log(`fetched badge id=${id}`)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError(`getBadge id=${id}`)));
    }
    ...
    searchBadges(term) {
        ...
        return this.http.get(`${this.badgesUrl}/?name=${term}`).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(x => x.length ?
            this.log(`found badges matching "${term}"`) :
            this.log(`no badges matching "${term}"`)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('searchBadges', [])));
    }
    //////// Save methods //////////
    /** POST: add a new badge to the server */
    addBadge(badge) {
        return this.http.post(this.badgesUrl, badge, this.httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])((newBadge) => this.log(`added badge w/ id=${newBadge.id}`)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('addBadge')));
    }
    /** DELETE: delete the badge from the server */
    deleteBadge(badge) {
        const id = typeof badge === 'number' ? badge : badge.id;
        const url = `${this.badgesUrl}/${id}`;
        return this.http.delete(url, this.httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(_ => this.log(`deleted badge id=${id}`)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('deleteBadge')));
    }
    /** PUT: update the badge on the server */
    updateBadge(badge) {
        return this.http.put(this.badgesUrl, badge, this.httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(_ => this.log(`updated badge id=${badge.id}`)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('updateBadge')));
    }
    /**
    ...
    log(message) {
        this.messageService.add(`BadgeService: ${message}`);
    }
};
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _badge_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../badge.service */ "./src/app/badge.service.ts");
...
let BadgesComponent = class BadgesComponent {
    ...
    add(name) {
        ...
        this.badgeService.addBadge({ name })
            .subscribe(badge => {
...
BadgesComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-badges',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./badges.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/badges/badges.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./badges.component.css */ "./src/app/badges/badges.component.css")).default]
    })
], BadgesComponent);
...
let DashboardComponent = class DashboardComponent {
    ...
    getBadges() {
        this.badgeService.getBadges().subscribe(badges => this.badges = badges.slice(1, 5));
    }
};
...
let InMemoryDataService = class InMemoryDataService {
    ...
    // badge id + 1.
    genId(badges) {
        return badges.length > 0 ? Math.max(...badges.map(badge => badge.id)) + 1 : 11;
    }
};
...
module.exports = __webpack_require__(/*! C:\Users\glady\SeniorDesign\spProject\src\main.ts */"./src/main.ts");
